            ...
            <div class="card-body p-4">
                <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                    <div>
                        ...
                        <p class="text-white text-sm opacity-9 mb-0">Monitorea pedidos e inventario en un solo vistazo y
                            accede rápido a las tareas críticas.</p>
                    </div>
            ...
            <div class="card-body">
                ...
                <div class="progress mt-3" style="height: 6px;">
                    <div class="progress-bar bg-gradient-danger" role="progressbar"
                        style="width: <?php echo $pendientesPercent; ?>%;"
                        aria-valuenow="<?php echo $pendientesPercent; ?>" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <p class="text-xs text-secondary mt-2 mb-0"><?php echo $pendientesPercent; ?>% de avance sobre el total
                </p>
            </div>
        </div>
    </div>
            ...
            <div class="card-body">
                ...
                <div class="progress mt-3" style="height: 6px;">
                    <div class="progress-bar bg-gradient-warning" role="progressbar"
                        style="width: <?php echo $procesoPercent; ?>%;" aria-valuenow="<?php echo $procesoPercent; ?>"
            ...
            <div class="card-body">
                ...
                <div class="progress mt-3" style="height: 6px;">
                    <div class="progress-bar bg-gradient-success" role="progressbar"
                        style="width: <?php echo $finalizadosPercent; ?>%;"
                        aria-valuenow="<?php echo $finalizadosPercent; ?>" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <p class="text-xs text-secondary mt-2 mb-0"><?php echo $finalizadosPercent; ?>% de avance sobre el
                    total.</p>
            </div>
        </div>
    </div>
        ...
        <div class="card h-100 shadow-sm">
            ...
            <div class="card-body pt-3">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-3">
                    ...
                    <div>
                        <p class="text-xs text-secondary mb-1">Pendientes <?php echo $pendientesPercent; ?>% · En
                            proceso <?php echo $procesoPercent; ?>% · Finalizados <?php echo $finalizadosPercent; ?>%
                        </p>
                    </div>
                </div>
                ...
                <div class="d-flex flex-wrap gap-2 mt-3">
                    <span class="badge bg-gradient-danger">Pendientes:
                        <?php echo $data['pendientes']['total']; ?></span>
                    <span class="badge bg-gradient-warning">Proceso: <?php echo $data['procesos']['total']; ?></span>
                    <span class="badge bg-gradient-success">Finalizados:
                        <?php echo $data['finalizados']['total']; ?></span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card h-100 shadow-sm">
            ...
            <div class="card-body">
                <p class="text-xs text-secondary mb-2">Utiliza esta vista para analizar los productos más vendidos y
                    tomar decisiones basadas en su rendimiento.</p>
                <div class="chart-container-1 chart-container-equal">
