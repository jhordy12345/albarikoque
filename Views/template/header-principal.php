        ...
        <div class="containt_main">
          ...
          <div id="mySidenav" class="sidenav">
            ...
            <?php foreach ($data['categorias'] as $categoria) { ?>
              <a href="#" onclick="irACategoria(<?php echo $categoria['id']; ?>)">
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
              <a class="dropdown-item" href="<?php echo BASE_URL; ?>"><i class="fa-solid fa-house"></i> Inicio</a>
              <a class="dropdown-item" href="#" onclick="mostrarCategorias(event)">
                <i class="fa-solid fa-list"></i> Categorías
              </a>
              <a class="dropdown-item" href="<?php echo BASE_URL; ?>productos"><i class="fa-solid fa-box"></i> Productos</a>
              <a class="dropdown-item" href="<?php echo BASE_URL; ?>carrito"><i class="fa-solid fa-cart-shopping"></i> Carrito</a>
            </div>
          </div>
                ...
                <?php if (empty($_SESSION['nombreCliente'])) { ?>
                  <li>
                    <a href="#" data-toggle="modal" data-target="#modalLogin">
                      ...
                      <span class="padding_10">Acceder</span>
                    </a>
                  </li>
                <?php } else { ?>
                  <li>
                    <a href="<?php echo BASE_URL; ?>clientes">
                      <i class="fa fa-user" aria-hidden="true"></i>
                      <span class="padding_10 text-capitalize">
