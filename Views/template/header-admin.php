  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="<?php echo BASE_URL; ?>" target="_blank">
        <img src="<?php echo BASE_URL; ?>assets/images/logo_abarikoque.png" class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-1 font-weight-bold text-white">ADMINISTRACION</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link text-white <?php echo ($data['title'] == 'administracion') ? 'active bg-gradient-info' : ''; ?>" href="<?php echo BASE_URL . 'admin/home'; ?>">
        ...
        <li class="nav-item">
          <a class="nav-link text-white <?php echo ($data['title'] == 'productos') ? 'active bg-gradient-info' : ''; ?>" href="<?php echo BASE_URL . 'productos'; ?>">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link text-white <?php echo ($data['title'] == 'pedidos') ? 'active bg-gradient-info' : ''; ?>" href="<?php echo BASE_URL . 'pedidos'; ?>">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
