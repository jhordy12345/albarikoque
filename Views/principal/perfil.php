...
<div class="container py-5">
                                    ...
                                    <div class="accordion" id="accordionExample">
                                        <div class="card">
                                            <div class="card-header" id="headingOne">
                                                ...
                                                <!-- Contenedor para la imagen del código QR (inicialmente oculto) -->
                                                <div id="qrCodeContainer" style="display: none; text-align: center;">
                                                    <img src="assets/images/qr_yape.jpg" alt="Código QR de Yape"
                                                        style="width: 300px; max-width: 100%; border-radius: 10px; box-shadow: 0 0 10px rgba(0,0,0,0.2);">
                                                    <br><br>

                                                    <!-- Descripción + Botón de WhatsApp -->
                                                    <div class="text-center my-4">
                                                        <p class="mb-3">
                                                            📸 Envíanos por aquí la <strong>captura de tu pago por
                                                                Yape</strong> 💰 y realiza tu <strong>pedido
                                                                directamente</strong>
                                                            con nosotros por WhatsApp.
                                                        </p>

                                                        <a href="https://wa.me/51904902527?text=Hola%20Albarikoque%2C%20te%20env%C3%ADo%20la%20captura%20de%20mi%20pago%20por%20Yape%20y%20quiero%20realizar%20mi%20pedido."
                                                ...
                                                <script>
                                                function showQRCode() {
                                                    // Obtener el contenedor de la imagen del código QR
                                                    var qrCodeContainer = document.getElementById("qrCodeContainer");

                                                    // Mostrar el contenedor (código QR) cuando se hace clic en el botón
    ...
    <div class="alert alert-danger text-center" role="alert">
        ...
        <a class="btn btn-danger" href="<?php echo BASE_URL . 'clientes/salir'; ?>"><i class="fas fa-times-circle"></i>
            Cerrar Sesión</a>
    </div>
    <?php } ?>
</div>
