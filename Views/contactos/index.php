                ...
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col-lg-5 d-none d-lg-block text-right">
                        <img src="<?php echo BASE_URL; ?>assets/images/logo_abarikoque.png"
                            alt="Ilustración de contacto" class="img-fluid contact-hero__image">
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="col-lg-5 mb-4">
                        <div class="card shadow-sm border-0 h-100">
                            <div class="card-body p-4">
                                ...
                                <p class="text-muted">Visítanos o contáctanos a través de cualquiera de los siguientes
                                    medios.
                                </p>
                                ...
                                <div class="d-flex align-items-center">
                                    <a href="https://www.facebook.com/albarikoqueperu"
                                        class="btn btn-outline-secondary btn-sm mr-2" target="_blank"><i
                                            class="fa-brands fa-facebook-f"></i></a>
                                    <a href="https://www.instagram.com/albarikoque.oficial"
                                        class="btn btn-outline-secondary btn-sm mr-2" target="_blank"><i
                                            class="fa-brands fa-instagram"></i></a>
                                    <a href="#" class="btn btn-outline-secondary btn-sm mr-2"><i
                    ...
                    <div class="col-lg-7">
                        <div class="card shadow-sm border-0">
                            <div class="card-body p-4">
                                ...
                                <p class="text-muted">Completa el formulario y nuestro equipo se comunicará contigo en
                                    el menor
                                    tiempo posible.</p>
                                <form id="formContactos">
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label for="nombre"><i class="fa-solid fa-user mr-1"></i> Nombre
                                                completo</label>
                                            <input type="text" class="form-control" id="nombre" name="nombre"
                                                placeholder="Ingresa tu nombre" required>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="email"><i class="fa-solid fa-envelope mr-1"></i> Correo
                                                electrónico</label>
                                    ...
                                    <div class="form-group">
                                        <label for="telefono"><i class="fa-solid fa-mobile-screen-button mr-1"></i>
                                            Teléfono (opcional)</label>
                                        <input type="tel" class="form-control" id="telefono" name="telefono"
                                            placeholder="Número de contacto">
                                    </div>
                                    <div class="form-group">
                                        <label for="mensaje"><i class="fa-solid fa-comment-dots mr-1"></i> ¿Cómo podemos
                                            ayudarte?</label>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between flex-wrap">
                                        <small class="text-muted">Al enviar aceptas nuestras políticas de
                                            privacidad.</small>
                    ...
                    <div class="card-body p-0">
                        <div class="embed-responsive embed-responsive-21by9">
                            <iframe class="embed-responsive-item"
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3905.551005986857!2d-74.249944!3d-12.938222!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTLCsDU2JzE3LjYiUyA3NMKwMTQnNTkuOCJX!5e0!3m2!1ses-419!2spe!4v1700000000000!5m2!1ses-419!2spe"
            ...
            fetch(`${base_url}contactos/enviar`, {
                ...
                .then(data => {
                    if (data.icono) {
                        ...
                        alertaPerzanalizada('Hubo un problema al procesar tu solicitud.', 'error',
                            'Contáctanos');
                    }
                })
                .catch(() => {
                    alertaPerzanalizada('No pudimos enviar tu mensaje. Inténtalo nuevamente.',
                        'error', 'Contáctanos');
                });
        });
    });
